...
(function (factory) {
    ...
    $.extend(FixedColumns.prototype, {
        ...
        fnGetPosition: function (node) {
            ...
            if (!$(node).parents('.DTFC_Cloned').length) {
                ...
                if (node.nodeName.toLowerCase() === 'tr') {
                    ...
                    var row = inst.fnGetPosition(
                        $('tr', this.s.dt.nTBody)[idx],
                    );
        ...
        _fnGridLayout: function () {
            ...
            var iFullHeight =
                this.s.dt.nTable.parentNode.parentNode.offsetHeight;
            var oOverflow = this._fnDTOverflow();
            ...
            if (this.s.iRightColumns > 0) {
                ...
                if (this.s.rtl) {
                    ...
                    wrapper.style.left = '';
                    wrapper.style.right = oOverflow.y
                        ? oOverflow.bar + 'px'
                        : 0;
                }
                ...
                oGrid.right.headBlock.style.display = oOverflow.y
                    ? 'block'
                    : 'none';
                oGrid.right.footBlock.style.display = oOverflow.y
                    ? 'block'
                    : 'none';
            }
        },
        ...
        _fnClone: function (oClone, oGrid, aiColumns, bAll) {
            ...
            if (dt.nTFoot !== null) {
                if (bAll) {
                    ...
                    for (i = 0, iLen = aoCloneLayout.length; i < iLen; i++) {
                        for (
                            j = 0, jLen = aoCloneLayout[i].length;
                            j < jLen;
                            j++
                        ) {
            ...
            if (that.s.dt.nTFoot !== null) {
                anUnique = dt.oApi._fnGetUniqueThs(
                    dt,
                    $('>tfoot', oClone.footer)[0],
                );
                $(anUnique).each(function (i) {
