...
(function () {
    ...
    var Criteria = /** @class */ (function () {
        function Criteria(table, opts, topGroup, index, depth) {
            ...
            this.dom = {
                ...
                valueTitle: $$2(
                    '<option value="--valueTitle--" selected/>',
        ...
        Criteria.prototype.setListeners = function () {
            var _this = this;
            this.dom.data.unbind('change').on('change', function () {
            ...
            this.dom.condition.unbind('change').on('change', function () {
        ...
        Criteria.inputValueSelect = function (el) {
            ...
            for (var _i = 0, el_3 = el; _i < el_3.length; _i++) {
                ...
                if (element.is('select')) {
                    ...
                    values.push(
                        element.children('option:selected').attr('type') ===
                            'Array'
                            ? val.split(',').sort()
                            : val,
                    );
    ...
    var Group = /** @class */ (function () {
        ...
        Group.prototype._setCriteriaListeners = function (criteria) {
            var _this = this;
            criteria.dom['delete'].unbind('click').on('click', function () {
            ...
            criteria.dom.right.unbind('click').on('click', function () {
            ...
            criteria.dom.left.unbind('click').on('click', function () {
        ...
        Group.prototype._setClearListener = function () {
            var _this = this;
            this.dom.clear.unbind('click').on('click', function () {
                if (!_this.s.isChild) {
        ...
        Group.prototype._setGroupListeners = function (group) {
            ...
            group.dom.add.unbind('click').on('click', function () {
                _this.setupLogic();
                _this.dom.container.trigger('dtsb-add');
                return false;
            });
            group.dom.container.unbind('dtsb-add').on('dtsb-add', function () {
                _this.setupLogic();
                _this.dom.container.trigger('dtsb-add');
                return false;
            });
        ...
        Group.prototype._setLogicListener = function () {
            var _this = this;
            this.dom.logic.unbind('click').on('click', function () {
                _this._toggleLogic();
                _this.s.dt.draw();
                for (var _i = 0, _a = _this.s.criteria; _i < _a.length; _i++) {
                    var crit = _a[_i];
