...
(function () {
    ...
    var h,
        ...
        r = (function () {
            function c(a, b, d, e, f) {
                ...
                this.dom = {
                    ...
                    dataTitle: h(
                        '<option value="" disabled selected hidden/>',
                    ).text(this.s.dt.i18n('searchBuilder.data', b.data)),
                    defaultValue: h('<select disabled/>')
                        .addClass(this.classes.value)
                        .addClass(this.classes.dropDown)
                        .addClass(this.classes.select),
                    delete: h('<button>&times</button>')
                    ...
                    ).text(this.s.dt.i18n('searchBuilder.value', b.value)),
                };
                if (this.c.greyscale)
                    for (
                            ...
                            for (f = a.dom.value; e < f.length; e++)
                                (g = f[e]),
                                    a.s.filled &&
                                        void 0 !== g &&
                                        0 !==
                                            a.dom.container.has(g[0]).length &&
                                        ((a.s.filled = !1),
                                        a.s.dt.draw(),
                                        a.setListeners());
            ...
            c.initSelect = function (a, b, d, e) {
                ...
                for (var u = [], C = [], H = 0; H < g.length; H++) {
                    ...
                    'array' === a.s.type &&
                        ((z = Array.isArray(z) ? (z = z.sort()) : [z]),
                        (A = Array.isArray(A) ? (A = A.sort()) : [A]));
                    var J = function (w, y) {
                        w = h('<option>', {
                    ...
                    if (e) for (var F = 0; F < z.length; F++) J(z[F], A[F]);
                    else J(z, A);
                }
                C.sort(function (w, y) {
                    if (
                ...
                for (e = 0; e < C.length; e++) q.append(C[e]);
                return q;
            };
            ...
            c.inputValueSelect = function (a) {
                for (var b = [], d = 0; d < a.length; d++) {
                    ...
                    if (e.is('select')) {
                        ...
                        b.push(
                            'Array' ===
                                e.children('option:selected').attr('type')
                                ? f.split(',').sort()
                                : f,
                        );
                    }
        ...
        G = (function () {
            ...
            c.prototype._setCriteriaListeners = function (a) {
                var b = this;
                a.dom['delete'].unbind('click').on('click', function () {
                    b._removeCriteria(a);
                ...
                a.dom.right.unbind('click').on('click', function () {
                    var d = a.s.index,
                        e = new c(
                            b.s.dt,
                            b.s.opts,
                ...
                a.dom.left.unbind('click').on('click', function () {
                    b.s.toDrop = new r(
                        b.s.dt,
                        b.s.opts,
                        b.s.topGroup,
            ...
            c.prototype._setGroupListeners = function (a) {
                var b = this;
                a.dom.add.unbind('click').on('click', function () {
                    b.setupLogic();
                    b.dom.container.trigger('dtsb-add');
                    return !1;
                });
                a.dom.container.unbind('dtsb-add').on('dtsb-add', function () {
                    b.setupLogic();
                    b.dom.container.trigger('dtsb-add');
                    return !1;
                });
        ...
        I = (function () {
            function c(a, b) {
                var d = this;
                if (!D || !D.versionCheck || !D.versionCheck('1.10.0'))
                    throw Error(
                        'SearchBuilder requires DataTables 1.10 or newer',
                    );
                a = new D.Api(a);
            ...
            c.prototype._setUp = function (a) {
                ...
                this._setClearListener();
                this.s.dt.on('stateSaveParams', function (n, q, u) {
                    u.searchBuilder = b.getDetails();
                    u.page = b.s.dt.page();
                });
                this._build();
                this.s.dt.on('preXhr', function (n, q, u) {
            ...
            c.prototype._build = function () {
                ...
                x.fn.dataTable.ext.search.includes(this.s.search) ||
                    ((this.s.search = function (e, f, g, n) {
    ...
    (function (c) {
        ...
        c(b).on('preInit.dt.dtsp', function (f, g, n) {
            'dt' === f.namespace &&
